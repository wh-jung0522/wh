    ...
    TwbsPagination.prototype = {
        ...
        buildListItems: function (pages) {
            ...
            if (this.options.prev) {
                var prev = pages.currentPage > 5 ? pages.currentPage - 5 : this.options.loop ? this.options.totalPages  : 1;
            ...
            if (this.options.next) {
                var next = pages.currentPage + 5 < this.options.totalPages ? pages.currentPage + 5 : this.options.loop ? 0 : this.options.totalPages;
